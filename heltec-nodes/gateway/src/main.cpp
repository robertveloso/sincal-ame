...
const char *ssid = "VELOSO DIGITAL";
const char *passphrase = "rv193755";
String st;
String content;
...
void receive()
{
  ...
  if (packetSize > SETDATA.length())
  {
    ...
    if (received.equals(SETDATA))
    {
      ...
      client.publish("a663ab60-80b0-11e9-9375-05b17602acf8/9606f130-8733-11e9-a915-c31d0eed4cca/updated", msg.c_str());
    }
    /*
...
void messageReceived(String &topic, String &payload)
{
  ...
  gateway_id = "a663ab60-80b0-11e9-9375-05b17602acf8/f6b00f80-86ca-11e9-adbc-7b8e4b4feb60";
...
setupAP();*/
  ...
  ecode = "2186";*/
    ...
    String service_url = "http://10.0.0.10:3456/api/v1/nodes/register/6494"; //+ecode;
    ...
    service_url = "http://10.0.0.10:3456/api/v1/nodes/register/6104"; //+ecode;
    Serial.println(service_url);
    http.begin(service_url); //Specify the URL and certificate
...
void loop()
{
  ...
  if (!client.connected())
  {
    ...
    String gateway_id = "a663ab60-80b0-11e9-9375-05b17602acf8/f6b00f80-86ca-11e9-adbc-7b8e4b4feb60";
    connectMQTTServer(gateway_id);
